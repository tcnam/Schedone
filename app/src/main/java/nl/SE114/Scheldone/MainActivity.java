...
import nl.kleisauke.Scheldone.db.Task;
import nl.kleisauke.Scheldone.db.TaskHelper;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.setBackgroundColor(Color.parseColor("#8E98F5"));
        TabLayout.Tab fourthTab = tabLayout.newTab();
        TabLayout.Tab firstTab = tabLayout.newTab();// Create a new Tab names "First Tab"
        TabLayout.Tab secondTab = tabLayout.newTab();
        TabLayout.Tab thirdTab = tabLayout.newTab();

        fourthTab.setIcon(R.drawable.baseline_list);
        firstTab.setIcon(R.drawable.basel);// set an icon for the first tab
        secondTab.setIcon(R.drawable.bas);
        thirdTab.setIcon(R.drawable.ba);
        tabLayout.addTab(fourthTab,0);
        tabLayout.addTab(firstTab,1);
        tabLayout.addTab(secondTab,2);
        tabLayout.addTab(thirdTab,3);
...
// get the current selected tab's position and replace the fragment accordingly
                                                   ...
                                                   switch (tab.getPosition()) {
                                                       case 1:
                                                           ...
                                                           break;
                                                       case 2:
                                                           Intent ip2 = new Intent(MainActivity.this,Scratch.class);
                                                           startActivity(ip2);
                                                           break;
                                                       case 3:
                                                           Intent ip3 = new Intent(MainActivity.this,Images.class);
                                                           startActivity(ip3);
                                                           break;
                                                   }
                                               }
...
//        }
    ...
    public void EmptyNotification() {
        ...
        Notification noti = new Notification.Builder(MainActivity.this).setContentTitle("No tasks today" + "    " + strDate + " " + curTime).setContentText("Enjoy Your day..").setLights(Color.WHITE, 2000, 3000).setSmallIcon(R.mipmap.ic_launcher1).setContentIntent(pIntent).setAutoCancel(true).setSound(alarmSound).addAction(R.drawable.baseline_add, "Add Task", pIntent).build();
        NotificationManager notificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
...
//        Uri alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        ...
        Notification noti = new Notification.Builder(MainActivity.this).setContentTitle(g + i + " Tasks Remaining" + "    " + strDate + "    " + curTime).setContentText(h).setLights(Color.WHITE, 2000, 3000).setSmallIcon(R.mipmap.ic_launcher1).setContentIntent(pIntent)
//                .setSound(alarmSound)
